...
<p>Property page for option <strong><?php echo $ocode;?></strong>.</p>
				<form action="modify_handler.php" method="post" name="formAdd"
					id="formAdd">
					<table class="table table-bordered table-hover table-striped">
						<tbody>
							<tr>
								...
								<td>
								<input type="hidden" id="option_group" name="option_group" style="width:300px" 
								class="option_group" value="<?php echo $objOption->getGroup();?>" <?php echo $isreadonly;?>/>
								</td>
							</tr>
							<tr>
								<th align="right">Code :</th>
								<td>
								<input class="form-control ks-form-control validate[required,length[0,255]]" 
								type="text" name="option_code" id="option_code" size="50" value="<?php echo $ocode;?>" <?php echo $isreadonly;?>>
								<div id="divIdnoAvailable" class="font-error"><p class="text-danger">Code already exists.Please insert new code.</p></div>
								</td>
							</tr>
							<tr>
								<th align="right">Description:</th>
								<td>
								<textarea id="option_desc" name="option_desc" cols="50" rows="4" 
								class="form-control ks-form-control"><?php echo $objOption->getDesc();?></textarea>
								</td>
							</tr>
							<tr>
								<th align="right">Value:</th>
								<td>
								<textarea id="option_value" name="option_value" cols="50" rows="4" 
								class="form-control ks-form-control"><?php echo $objOption->getValue();?></textarea>
								</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td><input name="btnSubmit" type="submit"
									class="btn btn-primary" id="btnSubmit" value="Save" />
									<input type="hidden" value="<?php echo $ocode;?>" id="ocode" name="ocode"> or <a
									href="display.php?ocode=<?php echo $ocode;?>">Cancel</a>
